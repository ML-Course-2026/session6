...
1.  **Topic Assignment**:
    *   Groups 1, 4, 7, 10: **TinyML** (Focus: The underlying philosophy, goals, and types of resources available, building on the lecture).
    *   Groups 2, 5, 8, 11, 13: **Edge Impulse** (Focus: What the platform does end-to-end, key features, types of projects it enables).
    *   Groups 3, 6, 9, 12: **SensiML** (Focus: What the platform does end-to-end, key features, how it might compare/contrast with other tools).
